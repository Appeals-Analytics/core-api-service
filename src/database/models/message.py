...
class Message(Base):
    ...
    category_level_1: Mapped[CategoryLevel1Enum] = mapped_column(
        category_level_1_enum, index=True
    )

    category_level_2: Mapped[list[CategoryLevel2Enum]] = mapped_column(
        ARRAY(category_level_2_enum)
    )
