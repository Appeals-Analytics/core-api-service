...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_messages_emotion_label"), "messages", ["emotion_label"], unique=False
    )
    op.create_index(
        op.f("ix_messages_event_date"), "messages", ["event_date"], unique=False
    )
    op.create_index(
        op.f("ix_messages_external_id"), "messages", ["external_id"], unique=False
    )
    op.create_index(
        op.f("ix_messages_lang_code"), "messages", ["lang_code"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_messages_content_search", table_name="messages", postgresql_using="gin"
    )
    op.drop_index(op.f("ix_messages_category_level_1"), table_name="messages")
    op.drop_index(
        "ix_messages_cat_level_2", table_name="messages", postgresql_using="gin"
    )
